...
window.onload = function() {
  var subjectSel = document.getElementById("country").value;
  var topicSel = document.getElementById("states").value;
  var chapterSel = document.getElementById("cities").value;
